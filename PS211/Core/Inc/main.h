...
/* Private defines -----------------------------------------------------------*/
#define JOY_XR_Pin GPIO_PIN_0
#define JOY_XR_GPIO_Port GPIOC
#define JOY_YR_Pin GPIO_PIN_1
#define JOY_YR_GPIO_Port GPIOC
#define GL_R_Pin GPIO_PIN_2
#define GL_R_GPIO_Port GPIOC
#define GL_L_Pin GPIO_PIN_3
#define GL_L_GPIO_Port GPIOC
#define JOY_XL_Pin GPIO_PIN_0
#define JOY_XL_GPIO_Port GPIOA
#define JOY_YL_Pin GPIO_PIN_1
...
#define BL_L_Pin GPIO_PIN_4
#define BL_L_GPIO_Port GPIOC
#define BL_R_Pin GPIO_PIN_5
#define BL_R_GPIO_Port GPIOC
#define WX_L_Pin GPIO_PIN_0
#define WX_L_GPIO_Port GPIOB
#define WX_R_Pin GPIO_PIN_1
#define WX_R_GPIO_Port GPIOB
